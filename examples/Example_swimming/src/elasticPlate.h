...
class elasticPlate
{
	...
	std::vector<Vector2i> coupleEdge;
	std::vector<edgeElement> v_coupleStretching;
	std::vector<Vector2i> coupleBend;
	std::vector<bendingElementNew> v_coupleBending;
	std::vector<angleElement> v_coupleAngle;
