...
elasticBendingBound::elasticBendingBound(elasticPlate &m_plate, timeStepper &m_stepper)
{
	plate = &m_plate;
    stepper = &m_stepper;
    ...
    gradKappa1 = MatrixXd::Zero(bendingNum,14);
    gradKappa2 = MatrixXd::Zero(bendingNum,14);
...
elasticBendingBound::~elasticBendingBound()
{
	;
}
